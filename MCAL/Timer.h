 ...
 * In/Out:
 * Return: The error status of the function.
 * Description: This function sets the callback operation.
 *
 */
extern ERROR_STATUS Timer_SetCallBack(Timer_cfg_s* Timer_cfg);
 ...
 * Input:
 * 	Timer_CH_NO: The channel number of the timer needed to get its value.
 * 	Data: This is the input variable of the function which holds the required value of the timer.
 * Output:
 * In/Out:
 * Return: The error status of the function.
